...
class jbasadre : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_jbasadre)
        ...
        val textView0 = findViewById<TextView>(R.id.textView10)
        val textView1 = findViewById<TextView>(R.id.textView11)
        val textView2 = findViewById<TextView>(R.id.textView12)
        val textView3 = findViewById<TextView>(R.id.textView13)
